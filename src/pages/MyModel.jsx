        ...
        <div>
            <div className="min-h-screen text-gray-800 dark:text-gray-200 px-3 sm:px-6 py-10">
                <div className="max-w-6xl mx-auto">
                    ...
                    <p className='my-4 text-center text-black'>Created by : {user.email}</p>
                            ...
                            <table className="w-full text-left border-collapse">
                                ...
                                <thead className="bg-blue-500 text-white text-sm sm:text-base">
                                    <tr>
                                        ...
                                        <th className="px-3 sm:px-5 py-3 text-center">Action</th>
                                    </tr>
                                </thead>
                                        ...
                                        >
                                            ...
                                            <td className="px-3 sm:px-5 py-3 text-center">
                                                <div className="flex justify-center">
                                                    <Link
                                                        to={`/model/${model._id}`}
                                                        className="bg-blue-500 hover:bg-blue-600 text-white text-xs sm:text-sm px-3 py-1.5 sm:px-4 sm:py-2 rounded-lg font-medium shadow-sm whitespace-nowrap"
                                                    >
                                                        View Details
                                                    </Link>
                                                </div>
